...
export type AuditAction =
  ...
  | "BLOG_TAG_UPDATE"
  | "BLOG_TAG_DELETE"
  | "BLOG_COMMENT_MODERATE"
  | "BLOG_REVIEW_MODERATE"
  | "BLOG_REPORT_RESOLVE"
  | "BLOG_LINK_CREATE"
  | "BLOG_LINK_UPDATE"
  | "BLOG_LINK_DELETE"
  ...
  | "BLOG_GALLERY_UPDATE"
  | "BLOG_GALLERY_DELETE"
  | "BLOG_GALLERY_MEDIA_ADD"
  | "BLOG_GALLERY_MEDIA_REMOVE"
  | "BLOG_NEWSLETTER_SUBSCRIBE"
  | "BLOG_NEWSLETTER_CONFIRM"
  | "BLOG_NEWSLETTER_UNSUBSCRIBE"
  | "BLOG_LINK_CHECK"
  | "BLOG_REACTION_ADD"
  | "BLOG_REACTION_REMOVE"
  | "BLOG_FAVORITE_ADD"
  | "BLOG_FAVORITE_REMOVE"
  | "BLOG_POST_VIEW"
  | "USER_PROFILE_UPDATE";

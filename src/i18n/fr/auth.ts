...
export default {
    ...
    cms: {
      ...
      pages: {
        ...
        legal: {
          ...
          confirmDeleteTab: 'Supprimer cet onglet et son contenu ?',
          confirmDeleteItem: 'Supprimer cet élément ?',
          moveUp: 'Monter',
          moveDown: 'Descendre',
          itemIndex: 'Élément',
          variables: 'Variables',
          variablesDescription: 'Cliquez sur une variable pour l\'insérer dans le dernier champ sélectionné.',
          variableInserted: 'Variable insérée.',
          noFieldFocused: 'Cliquez d\'abord dans un champ texte.',
          variableUnknown: '⚠ variable inconnue',
          variableEmpty: '⚠ vide',
          variableTrimmedSpaces: '⚠ espaces en trop',
          variableSpacesInName: '⚠ espaces dans le nom',
          variableInvalidBraces: '⚠ accolades incorrectes',
          varSiteName: 'Nom du site',
          varEmail: 'Email',
          varPhone: 'Téléphone',
          varAddress: 'Adresse',
          varCity: 'Ville',
          varPostalCode: 'Code postal',
          varCountry: 'Pays',
        },
      },
      media: {
        title: 'Médiathèque',
        description: 'Gérez les dossiers, fichiers et textes alternatifs multilingues.',
        counts: {
          file: 'fichier',
          files: 'fichiers',
          folder: 'dossier',
        ...
        folderNamePlaceholder: 'ex: bannieres',
        ...
        rename: 'Renommer',
        renameHint: 'Lettres, chiffres, tirets et underscores uniquement. Bon pour le SEO.',
        url: 'URL',
        copyUrl: 'Copier',
        ...
        noSelection: 'Sélectionnez un fichier pour voir ses détails.',
        altTexts: 'Textes alternatifs',
        altTextsDescription: 'Un texte par langue pour l\'accessibilité et le SEO.',
        altMissing: 'manquant',
        altPlaceholder: 'Texte alternatif',
        titlePlaceholder: 'Titre / infobulle',
        saveAltTexts: 'Enregistrer les textes alt',
        confirmDeleteFile: 'Supprimer ce fichier définitivement ?',
        ...
        pickerSearchPlaceholder: 'Rechercher…',
        pickerAllFolders: 'Tous les dossiers',
        pickerEmpty: 'Aucun média. Téléversez des fichiers dans la médiathèque.',
        pickerSelect: 'Sélectionner',
  ...
  organizations: {
    ...
    blog: {
      title: 'Blog',
      description: 'Gérez les articles, taxonomies et la modération de l\'organisation.',
    },
    media: {
      title: 'Médias',
      description: 'Gérez la bibliothèque média de l\'organisation et ses textes alternatifs multilingues.',
    },
    roles: {
      title: 'Rôles personnalisés',
      description: 'Créez et gérez les rôles personnalisés de votre organisation.',
      builtinTitle: 'Rôles prédéfinis',
      builtinDescription: 'Ces rôles sont appliqués automatiquement et ne peuvent pas être modifiés.',
      noCustomRoles: 'Aucun rôle personnalisé pour cette organisation.',
      createRole: 'Créer un rôle',
      editRole: 'Modifier',
      deleteRole: 'Supprimer',
      ...
      save: 'Enregistrer',
      cancel: 'Annuler',
      assignToMembers: 'Assigner aux membres',

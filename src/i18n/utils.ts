...
export async function getHomeTranslations(locale: Locale): Promise<HomeTranslations> { try { const mod = await homeModules[locale](); return mod.default; } catch (err) { if (locale !== DEFAULT_LOCALE) { console.error(`[i18n] Failed to load home translations for "${locale}":`, err); return (await homeModules[DEFAULT_LOCALE]()).default; } throw err; } }
...
export async function getAboutTranslations(locale: Locale): Promise<AboutTranslations> { try { const mod = await aboutModules[locale](); return mod.default; } catch (err) { if (locale !== DEFAULT_LOCALE) { console.error(`[i18n] Failed to load about translations for "${locale}":`, err); return (await aboutModules[DEFAULT_LOCALE]()).default; } throw err; } }
...
export async function getContactTranslations(locale: Locale): Promise<ContactTranslations> { try { const mod = await contactModules[locale](); return mod.default; } catch (err) { if (locale !== DEFAULT_LOCALE) { console.error(`[i18n] Failed to load contact translations for "${locale}":`, err); return (await contactModules[DEFAULT_LOCALE]()).default; } throw err; } }
...
export async function getAuthTranslations(locale: Locale): Promise<AuthTranslations> { try { const mod = await authModules[locale](); return mod.default; } catch (err) { if (locale !== DEFAULT_LOCALE) { console.error(`[i18n] Failed to load auth translations for "${locale}":`, err); return (await authModules[DEFAULT_LOCALE]()).default; } throw err; } }
...
export async function getBlogTranslations(locale: Locale): Promise<BlogTranslations> { try { const mod = await blogModules[locale](); return mod.default; } catch (err) { if (locale !== DEFAULT_LOCALE) { console.error(`[i18n] Failed to load blog translations for "${locale}":`, err); return (await blogModules[DEFAULT_LOCALE]()).default; } throw err; } }

...
export const servicesSearchDefinition: SearchResourceDefinition = {
  resourceId: "service",
  ...
  fields: [
    ...
    { name: "providerId", kind: "keyword", filterable: true, sortable: true },
    { name: "categoryId", kind: "keyword", filterable: true },
    { name: "tagId", kind: "keyword", filterable: true },
    { name: "isMobile", kind: "boolean", filterable: true },
    { name: "isFeatured", kind: "boolean", filterable: true, sortable: true },
    { name: "priceMinor", kind: "number", filterable: true, sortable: true },
...
assertSearchResourceDefinition(servicesSearchDefinition);
